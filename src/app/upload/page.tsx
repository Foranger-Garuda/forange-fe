...
export default function UploadPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#138048] px-4 sm:px-6 md:px-8">
      <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 w-full max-w-md sm:max-w-lg flex flex-col items-center">
        ...
        >
          <div
            className={`w-full border-2 border-dashed rounded-xl flex flex-col items-center justify-center p-6 sm:p-10 cursor-pointer transition-colors ${
              dragActive
                ? "border-[#138048] bg-green-50"
          ...
          >
            <FiUploadCloud className="text-4xl sm:text-5xl text-[#138048] mb-4" />
            <div className="text-base sm:text-lg font-medium mb-1">
              Drag & drop files or{" "}
              <span className="text-[#138048] underline cursor-pointer">
                Browse
              </span>
            </div>
              ...
              <div className="mt-4 w-full flex flex-col items-center">
                ...
                {loading && (
                  <div className="w-full bg-gray-200 rounded-full h-2.5">
                    <div
                      className="bg-[#138048] h-2.5 rounded-full animate-pulse"
                      style={{ width: "100%" }}
                    />
                  </div>
                )}
